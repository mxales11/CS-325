...
import minidraw.customized.tools.SnapToGridTool;
import minidraw.framework.*;
import java.awt.*;
import javax.swing.*;

/**
 * A (very small) jigsaw puzzle on the Aarhus University seal. A demonstration
...
class PuzzleFactory implements Factory {
	...
	public DrawingView createDrawingView(DrawingEditor editor) {
		...
		for (Grid dir : Grid.values()) {
			...
			jPanel.setName(dir.toString());
			((StdViewWithBackground) view).add(jPanel);
		}
