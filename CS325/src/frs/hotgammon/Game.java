...
public interface Game {
	...
	/**
	 * move one checker from one location to another. If the move is invalid,
	 * then no change is made on the board. If moving to a location occupied by
	 * a single opponent checker (standard backgammon rules) then the opponent
	 * checker is moved to the bar.
	 * 
	 * @param from
	 *            the location to move the checker from
	 * @param to
	 *            the location to move the checker to
	 ...
	 * move.
	 * 
	 * @return the color of the player to move next. If no player is in turn
	 *         (before the game is started), NONE is returned.
	 */
	 ...
	 * have not yet been used to move a checker. POSTCONDITION: The array is
	 * sorted so the largest die value is first in the array.
	 * 
	 ...
	 * 
	 * @param location
	 *            the location on the board to access
