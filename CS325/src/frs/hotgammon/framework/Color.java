...
/**
 * This class represents an enumeration of colours used in Backgammon. We need
 * to represent the red or the black colour - but also in some casese neither of
 * the colours, for instance if we ask what colour the checkers have on an empty
 * location on the board. This is represented by the NONE colour.
 * 
...
public enum Color {
	...
	/**
	 * private constructor means that no one else but this scope is allowed to
	 * define instances.
	 */
	 ...
	 * 
	 * @param value
	 *            a numerical value that represents a color
