...
public class CoreTests {
	...
	public CoreTests(RulesFactory gameVariantFactory) {
		game = new GameImpl(gameVariantFactory);
		game.newGame();
	...
	public static Collection<Object[]> data() {
		...
		{ new AlphaMon() }, { new BetaMon() }, { new GammaMon() },
				{ new DeltaMon() },
				{ new HandiCapMon(new AlphaMon(), new BetaMon())}
				};
	...
	@Test
	public void shouldBeNoMovesLeftAfterMovingTwoBlackCheckers() {
		game.nextTurn();
		game.move(Location.R1, Location.R2);
		game.move(Location.R1, Location.R3);
	...
	public void eachTurnThrowsCorrectNumberOfDice() {
		...
		game.nextTurn();
		game.nextTurn();
		System.out.println(game.diceThrown()[0]);
